...
def text_to_textnodes(text):
    ...
    delimited_node = split_nodes_delimiter(split_nodes_delimiter(split_nodes_delimiter(node, "`", TextType.CODE_TEXT), "**", TextType.BOLD_TEXT), "*", TextType.ITALIC_TEXT)
    return split_nodes_image(split_nodes_link(delimited_node))
